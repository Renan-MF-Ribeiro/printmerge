...
const DEFAULT_PHRASES: Phrase[] = [
  { text: 'O sucesso é a soma de pequenos esforços repetidos dia após dia.', category: PhraseCategory.MOTIVACIONAL },
  { text: 'Acredite em você mesmo e tudo será possível.', category: PhraseCategory.MOTIVACIONAL },
  { text: 'O único lugar onde o sucesso vem antes do trabalho é no dicionário.', category: PhraseCategory.EMPRESARIAL },
  { text: 'Tudo posso naquele que me fortalece.', category: PhraseCategory.BIBLICO },
  { text: 'A educação é a arma mais poderosa que você pode usar para mudar o mundo.', category: PhraseCategory.ESCOLAR },
  { text: 'Não espere por uma crise para descobrir o que é importante em sua vida.', category: PhraseCategory.MOTIVACIONAL },
  { text: 'O conhecimento é a única coisa que ninguém pode tirar de você.', category: PhraseCategory.ESCOLAR },
  ...
  { text: 'Inovação é o que distingue um líder de um seguidor.', category: PhraseCategory.EMPRESARIAL },
  { text: 'O aprendizado é uma jornada sem fim.', category: PhraseCategory.ESCOLAR },
  { text: 'Grandes realizações requerem tempo e dedicação.', category: PhraseCategory.MOTIVACIONAL },
];
