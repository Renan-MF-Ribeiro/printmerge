...
@Component({
  ...
  `,
  styles: [`
    .export-toolbar { display: flex; align-items: center; gap: 12px; padding: 16px 24px; background: #f7f9fc; border-top: 1px solid #e2e8f0; }
    .btn-export { padding: 10px 24px; background: #3182ce; color: white; border: none; border-radius: 6px; font-weight: 600; cursor: pointer; font-size: 14px; }
    .btn-export:disabled { opacity: 0.5; cursor: not-allowed; }
    .btn-export:hover:not(:disabled) { background: #2b6cb0; }
    .file-name { font-size: 13px; color: #718096; }
  `]
})
